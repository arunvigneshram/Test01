...
sql = """
    CREATE TABLE IF NOT EXISTS Chargers_Start_Stop (
        ...
        charger_start_stop VARCHAR(5) NOT NULL,
...
sql = """
    ...
    """
mycursor.execute(sql)
print("05. Charging_Session database created.")

# Create Charging_Unchanged table
sql = """
    CREATE TABLE IF NOT EXISTS Charging_Unchanged (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
        charger_id INT NOT NULL,
        rfid VARCHAR(25) NOT NULL,
        entry_check VARCHAR(5) NOT NULL
        )
    """
mycursor.execute(sql)
print("04. Charging_Unchanged database created.")
...
sql = """
    ...
    """
mycursor.execute(sql)
print("06. Charging_Load database created.")
